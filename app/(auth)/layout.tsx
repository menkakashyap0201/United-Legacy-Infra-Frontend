...
export const metadata: Metadata = {
  title: "Account — United Legacy Infra",
};

/*
  Shared design for /register, /login and /forgot-password (no site header or footer).
  Left: the page's card. Right (desktop only): hero photo + stat cards.
*/
